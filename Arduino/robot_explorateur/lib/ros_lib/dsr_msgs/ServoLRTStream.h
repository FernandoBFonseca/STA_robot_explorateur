#ifndef _ROS_dsr_msgs_ServoLRTStream_h
#define _ROS_dsr_msgs_ServoLRTStream_h
...
namespace dsr_msgs
{
  ...
  class ServoLRTStream : public ros::Msg
  {
    public:
      float pos[6];
      float vel[6];
    ...
    virtual const char * getType() override { return "dsr_msgs/ServoLRTStream"; };
