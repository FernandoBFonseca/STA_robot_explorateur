...
namespace image_exposure_msgs
{
  ...
  class SequenceExposureStatistics : public ros::Msg
  {
    ...
    SequenceExposureStatistics():
      exposures_length(0), st_exposures(), exposures(nullptr),
      underExposed(0),
      overExposed(0),
      meanIrradiance(0),
    ...
    virtual const char * getType() override { return "image_exposure_msgs/SequenceExposureStatistics"; };
    virtual const char * getMD5() override { return "2a4f3187c50e7b3544984e9e28ce4328"; };
