#ifndef _ROS_dsr_msgs_ServoJStream_h
#define _ROS_dsr_msgs_ServoJStream_h
...
namespace dsr_msgs
{
  ...
  class ServoJStream : public ros::Msg
  {
    public:
      float pos[6];
      float vel[6];
    ...
    virtual const char * getType() override { return "dsr_msgs/ServoJStream"; };
