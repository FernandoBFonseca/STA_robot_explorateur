...
namespace image_exposure_msgs
{
  ...
  class ImageExposureStatistics : public ros::Msg
  {
    ...
    virtual const char * getType() override { return "image_exposure_msgs/ImageExposureStatistics"; };
    virtual const char * getMD5() override { return "334dc170ce6287d1de470f25be78dd9e"; };
