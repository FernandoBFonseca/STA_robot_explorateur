#ifndef _ROS_dsr_msgs_SpeedLRTStream_h
#define _ROS_dsr_msgs_SpeedLRTStream_h
...
namespace dsr_msgs
{
  ...
  class SpeedLRTStream : public ros::Msg
  {
    public:
      float vel[6];
      float acc[6];
    ...
    virtual const char * getType() override { return "dsr_msgs/SpeedLRTStream"; };
