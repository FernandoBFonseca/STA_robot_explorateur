...
namespace image_exposure_msgs
{
  ...
  class ExposureSequence : public ros::Msg
  {
    ...
    ExposureSequence():
      header(),
      shutter_length(0), st_shutter(), shutter(nullptr),
      gain(0),
    ...
    virtual const char * getType() override { return "image_exposure_msgs/ExposureSequence"; };
    virtual const char * getMD5() override { return "81d98e1e20eab8beb4bd07beeba6a398"; };
